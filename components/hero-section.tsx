...
export function HeroSection() {
  return (
    <section className="relative pt-20 pb-36 lg:pt-28 lg:pb-52 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Desktop */}
        <h1 className="hidden md:block text-6xl font-bold text-primary mb-6 leading-tight">
          Your Wellness Journey
          <br />
          is Start <span className="text-secondary italic font-normal">Today</span>
        </h1>

        {/* Mobile */}
        <h1 className="block md:hidden text-5xl font-bold text-primary mb-6 leading-tight">
          Start Your Wellness
          <br />
          Journey with
          <br />
          Kindwell Clinic
          <br />
          <span className="text-secondary italic font-normal">Today</span>
        </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-3 w-full max-w-3xl">
            <Button
              variant="outline"
              className="h-14 text-lg font-semibold bg-transparent border-2 border-primary text-primary flex-1 rounded-xl"
            >
            ...
            <Button
              className="h-14 text-lg font-semibold flex-1 rounded-xl"
            >
              Free Consultation
            </Button>
          </div>
